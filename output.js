//Fri Dec 12 2025 10:42:30 GMT+0000 (Coordinated Universal Time)
...
async function _0x4e8124() {
  try {
    ...
    if (_0x5b1c46.data && _0x5b1c46.data.success && _0x5b1c46.data.data) {
      ...
      _0x243ae1("[成功] 已加载 " + _0x5b1c46.data.count + " 个券: " + _0x46e7f8, "success");
      return true;
    } else {
      {
    ...
    _0x3f2761.response && _0x3f2761.response.status === 403 ? (_0x243ae1("[错误] 获取券列表失败: IP未在白名单中 (403)", "error"), _0x243ae1("[提示] 请稍等片刻后重新运行脚本，或联系管理员手动添加IP", "warn"), _0x3f2761.response.data?.["ip"] && _0x243ae1("[提示] 需要添加的IP: " + _0x3f2761.response.data.ip, "warn")) : (_0x243ae1("[错误] 获取券列表失败: " + _0x3f2761.message, "error"), _0x243ae1("请检查网络连接或联系管理员", "error"));
    return false;
  }
}
...
async function _0x4ce4f3(_0x2ae23d) {
  ...
  try {
    ...
    if (_0x5cd9b9 && _0x5cd9b9.success === true) return _0x243ae1("✅ 卡密验证成功，允许运行脚本", "success"), true;else {
      _0x243ae1("❌ 卡密验证失败: " + (_0x5cd9b9?.["message"] || "验证不通过"), "error");
      _0x243ae1("请检查卡密是否正确，或联系Q群：1034077503", "warn");
      return false;
    }
  } catch (_0x492274) {
    _0x243ae1("❌ 卡密验证异常: " + _0x492274.message, "error");
    _0x243ae1("可能原因：网络连接失败或服务器无响应", "warn");
    _0x243ae1("请检查网络连接后重试，或联系Q群：1034077503", "warn");
    return false;
  }
}
async function _0x552ac1() {
  ...
  try {
    ...
    if (_0x30873c.data && _0x30873c.data.success) return _0x243ae1("白名单添加成功: " + _0x157b06, "success"), true;else {
      ...
      if (_0x51b468) {
        _0x243ae1("IP已在白名单中（可能是管理员手动添加）: " + _0x157b06, "success");
        return true;
    ...
    _0x243ae1("IP白名单操作异常: " + _0x2648e4.message, "error");
    return false;
  }
}
let _0x5f0770 = null,
...
async function _0x1f730a(_0x28765d, _0x56eeeb, _0x1cff7c) {
  ...
  if (_0x6bbb73.success && !_0x27a6a4) {
    ...
    _0x243ae1("[成功] 券 " + _0x5f504e + " 领取成功: " + _0x9d6089, "success");
    return {
      "success": true,
      "couponId": _0x28765d,
      "message": _0x9d6089
...
async function _0x108ea4(_0x414d18, _0x421f54, _0x1f1b5a) {
  ...
  _0x243ae1("========================================");
  _0x243ae1("领券完成: 成功 " + _0x238656 + " 个，失败 " + _0x4be65f + " 个");
  _0x29ceb4 > 0 && _0x243ae1("其中已领取: " + _0x29ceb4 + " 个", "warn");
  _0x389d58 > 0 && _0x243ae1("其中限制: " + _0x389d58 + " 个", "warn");
  _0x243ae1("========================================");
  return {
...
async function _0x191a48(_0x22e2c4, _0x2bdebf, _0x4274ce) {
  ...
  try {
    ...
    _0x243ae1("");
    let _0x93e22f;
    _0x4653c7.length === 1 ? _0x93e22f = await _0x1f730a(_0x4653c7[0], _0x1c9cbe, _0x530efc) : _0x93e22f = await _0x108ea4(_0x4653c7, _0x1c9cbe, _0x530efc);
    ...
    _0x243ae1("\n账号 " + _0x2bdebf + " 执行出错: " + _0x4df406.message, "error");
    console.error(_0x4df406);
    return {
      "userId": "unknown",
      "result": null,
      "success": false,
